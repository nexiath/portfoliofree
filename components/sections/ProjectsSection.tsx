...
export function ProjectsSection() {
  const projects = [
    ...
    },
    {
      id: 3,
      title: 'EthiCraft',
      description: 'AI ethics and bias detection simulator for responsible AI development.',
      longDescription: 'A comprehensive tool for testing and identifying biases in AI models. Includes simulation environments, bias detection algorithms, and educational resources for ethical AI development practices.',
      image: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=800',
      technologies: ['Python', 'React', 'Claude API', 'FastAPI', 'ML Libraries'],
      githubUrl: 'https://github.com',
